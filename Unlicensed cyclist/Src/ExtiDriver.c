...
void extInt_Config(EXTI_Config_t *extiConfig)
{
	...
	case 1: {
		/* SYSCFG_EXTICR1 */
        /*Agregue su código acá*/
		//Limpiamos la posicion a configurar
...
void EXT2_IRQHandler (void){
	//Evaluamos si la interrupción que se lanzó corresponde al PIN_2 del GPIO_X
...
void EXT3_IRQHandler (void){
	//Evaluamos si la interrupción que se lanzó corresponde al PIN_3 del GPIO_X
...
void EXT4_IRQHandler (void){
	//Evaluamos si la interrupción que se lanzó corresponde al PIN_4 del GPIO_X
